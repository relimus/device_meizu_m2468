...
BOARD_KERNEL_CMDLINE := video=vfb:640x400,bpp=32,memsize=3072000 qcom_geni_serial.con_enabled=1 nosoftlockup page_poison=1 sysrq_always_enabled bootconfig buildvariant=user
...
BOARD_MEIZU_DYNAMIC_PARTITIONS_PARTITION_LIST := \
    system \
    odm \
    system_dlkm \
    product \
